 ...
 * @author INFODAK
 */
public class PCardForAssignAppartementToClient extends RoundJPanel {
    private Login loginFrame;
    private int clientId;
    private AppartementData appartement;
    public PCardForAssignAppartementToClient(Login LoginFrame,int clientId,AppartementData appartement) {
    ...
    public void initListCard(){
        PFooterForAssignAppertementToClient pc = new PFooterForAssignAppertementToClient(this.loginFrame,clientId,this.appartement);
